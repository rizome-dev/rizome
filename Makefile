...
post-install: ## Post-installation setup
	...
	@echo "  1. Create a RIZOME.md file in your project directory"
	@echo "  2. Add common instructions and provider-specific overrides"
	@echo "  3. Run '$(COLOR_GREEN)rizome sync$(COLOR_RESET)' to synchronize provider configurations"
	@echo ""
	...
	@echo "  $(COLOR_GREEN)rizome sync$(COLOR_RESET)       Synchronize provider configurations"
